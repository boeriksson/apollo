...
class BaseContainer extends Component {
    ...
    render() {
        const {data: {loading, error, deposits}} = this.props;
        ...
        const activities = deposits.map(d => (
            <tbody key={d.depositRef}>
            <tr>
                <td>{d.depositRef}</td>
                <td>{d.timestmp}</td>
                <td>{d.amount}</td>
        ...
        const base = (
            <StyledBase>
                ...
                <TransactionList activities={ mockActivities }/>
                { activities }
            </StyledBase>
        );
...
BaseContainer.propTypes = {
    data: PropTypes.shape({
        ...
        deposits: PropTypes.arrayOf(PropTypes.shape({
            ...
            timestmp: PropTypes.number,
            depositRef: PropTypes.number
        }))
    })
};
